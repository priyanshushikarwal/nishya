...
const initialReviews: ReviewItem[] = [
  {
    ...
    product_id: products[0]?.id || "nishya-sample-1",
    product_name: products[0]?.name || "Safari Quilted Laptop Bag",
    product_image: products[0]?.image || "/images/nishya/carry_your_story_pink_arch.jpg",
    rating: 5,
  ...
  },
  {
    ...
    product_id: products[1]?.id || "nishya-sample-2",
    product_name: products[1]?.name || "Mughal Forest Laptop Bag",
    product_image: products[1]?.image || "/images/nishya/carry_your_story_black_gold.jpg",
    rating: 5,
  ...
  },
  {
    ...
    product_id: products[2]?.id || "nishya-sample-3",
    product_name: products[2]?.name || "Architectural Geometry Bag",
    product_image: products[2]?.image || "/images/nishya/carry_your_story_pink_float.jpg",
    rating: 4,
