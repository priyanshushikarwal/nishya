...
export const metadata: Metadata = {
  title: "Client Sign In | Nishya — Haute Maroquinerie",
  description: "Sign in to your private Nishya client account to view orders, track deliveries, and manage your bespoke collection.",
};
